...
RUN apt-get install -y apache2 php7.0 curl php7.0-cli php7.0-mysql php7.0-mcrypt php7.0-curl git gnupg php7.0-mbstring php7.0-xml unzip sudo curl php7.0-zip
